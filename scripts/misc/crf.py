...
def gather_data(train, dev, test):   # *_tgt files 
	...
	input_files = [train, dev, test, select] 
	dictionaries = (train_dict, dev_dict, test_dict, select_dict)
...
#    n_samples = 1000
	...
	return dictionaries, train_words, dev_words, test_words, select_words
...
def build(model_filename, dictionaries, train_words, dev_words, test_words, select_words, delta, epsilon, max_iterations):

	train_dict, dev_dict, test_dict, select_dict = dictionaries
...
#    crf.fit(X_train, Y_train, X_dev=X_dev, y_dev=Y_dev)
	...
	return Y_dev_predict, Y_test_predict, Y_select_predict
