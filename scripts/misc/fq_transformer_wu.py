...
def main(datadir, lang, size, arch, task = 'surSeg'):
    ...
    TESTIN = datadir + 'test.' + experiment[ : 3] + '_surSeg.input'
    TO_PREDICT = datadir + 'select.'+ experiment + '.input'
...
if __name__== '__main__':
    ...
    e.g. python scripts/fq_transformer_wu.py /blue/liu.ying/al_morphseg/al_pilot_data/ lez50'''
